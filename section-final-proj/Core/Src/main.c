...
const osThreadAttr_t txTask_attributes = {.name = "txTask",
                                          .priority =
...
int main(void)
{
    ...
    // timestamp source, must run before acquisition starts stamping blocks
...
/* USER CODE BEGIN Header_TxTask */
/**
 * @brief  Function implementing the txTask thread.
 * @param  argument: Not used
 * @retval None
 */
/* USER CODE END Header_TxTask */
void TxTask(void *argument)
{
    /* USER CODE BEGIN 5 */
